...
#     anonymized_telemetry: bool  # Add this line
#     # Other fields as needed
# CHROMA_SETTINGS = Settings(
#     persist_directory=persist_directory,
#     anonymized_telemetry=True  # Remove this line
#     # Other fields as needed
# )
...
def main():
    ...
    #   query_db = "What are the problems while connecting athena to S3?"
      ...
      # temp_answer = str(agent_query)
      # print("temp answer", temp_answer)
      # answer = agent(temp_answer)
      # print("agent answer is this -----------",answer)
